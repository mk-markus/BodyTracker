...
public static class ChartSeriesBuilder
{
    ...
    /// </summary>
    /// <remarks>Iterates through the provided series definitions, maps data points using configured selectors, and constructs normal measurement series and smoothed trend series based on visibility and trend flags.</remarks>
