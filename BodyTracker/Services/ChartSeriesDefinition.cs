...
namespace Shared.Charting;

public class ChartSeriesDefinition<T>
{
    /// <summary>
    /// Gets or sets the display name of the measurement series.
    /// </summary>
    ...
    /// </summary>
    /// <remarks>Used to label the calculated trend line corresponding to this measurement series in legends.</remarks>
    ...
    /// </summary>
    /// <remarks>Determines which Y-axis coordinate system the measurement series is bound to in multi-axis charts.</remarks>
    public int YAxisIndex { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether the series is visible.
    /// </summary>
    /// <remarks>Controls whether the measurement series is rendered in the charting component.</remarks>
    ...
    /// <summary>
    /// Gets or sets the function that extracts the measurement value.
    /// </summary>
    /// <remarks>A delegate used to map elements of type <typeparamref name="T"/> to their corresponding nullable numerical measurement values for vertical axis plotting.</remarks>
