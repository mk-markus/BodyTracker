...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FoodIntakeMap"/> class, mapping model properties to CSV columns.
    /// </summary>
    /// <remarks>Configures CsvHelper property mappings for <see cref="FoodIntakeModel"/> fields corresponding to Samsung Health data headers.</remarks>
...
/// <summary>
/// Represents the CsvHelper class map for mapping <see cref="StepDailyTrendModel"/> properties to CSV file headers.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StepDailyTrendMap"/> class, mapping model properties to CSV columns.
    /// </summary>
    /// <remarks>Configures CsvHelper property mappings for <see cref="StepDailyTrendModel"/> fields corresponding to Samsung Health data headers.</remarks>
