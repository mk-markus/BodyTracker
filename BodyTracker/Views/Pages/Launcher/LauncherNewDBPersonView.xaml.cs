...
namespace BodyTracker.Views.Pages
{
    ...
    public partial class LauncherNewDatabasePersonPage : Page
    {
        ...
        /// </summary>
        private readonly LauncherNewDBPersonViewModel launcherNewDatabasePersonPageViewModel;
        ...
        public LauncherNewDatabasePersonPage()
        {
            ...
            launcherNewDatabasePersonPageViewModel = new LauncherNewDBPersonViewModel();
