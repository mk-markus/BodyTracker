...
namespace BodyTracker.Views.Pages
{
    ...
    public partial class LauncherNewDatabaseConnectionPage : Page
    {
        ...
        /// </summary>
        private readonly LauncherNewDBConnectionViewModel launcherNewDatabaseConnectionPageViewModel;
        ...
        {
            InitializeComponent();
            launcherNewDatabaseConnectionPageViewModel = new LauncherNewDBConnectionViewModel();
