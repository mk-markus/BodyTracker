...
namespace BodyTracker.Views
{
    ...
    public partial class NewDataEntryView : Page
    {
        ...
        /// </remarks>
        private readonly NewDataEntryPageViewModel dataEntryViewModel;
        ...
        /// application's overall navigation lifecycle, such as switching back to the bodyMeasurement history 
        ...
        public NewDataEntryView(MainWindow shell, DatabaseService db)
        {
            ...
            this.Unloaded += (s, e) => dataEntryViewModel.Dispose();
        }
        ...
        /// and a navigation change to the bodyMeasurement overview is required.
        /// </summary>
