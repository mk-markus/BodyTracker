...
namespace BodyTracker.Views
{
    ...
    {
        /// <summary>
        /// A private, read-only reference to the <see cref="DataBaseEntriesBodyMeasurementPageViewModel"/>.
        ...
        /// </remarks>
        private readonly DataBaseEntriesBodyMeasurementPageViewModel measurementViewModel;
        ...
        /// <remarks>
        /// This constructor establishes the <see cref="DataContext"/> by creating a new <see cref="DataBaseEntriesBodyMeasurementPageViewModel"/>
        ...
        public DataBaseEntriesBodyMeasurementPage(MainWindow shell, DatabaseService db)
        {
            ...
            databaseService = db;
            _shell = shell;
            measurementViewModel = new DataBaseEntriesBodyMeasurementPageViewModel(databaseService);
