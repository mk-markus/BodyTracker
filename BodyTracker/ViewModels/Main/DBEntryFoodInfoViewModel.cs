...
{
    public partial class DBEntryFoodInfoViewModel : ObservableObject
    {  
        /// <summary>
       ...
       /// </remarks>
        ...
        /// </summary>
        [ObservableProperty] private ObservableCollection<SamsungFoodInfoModel> foodInfoDatas = new();

        /// <summary>
        /// Gets or sets the currently selected food info record from the list.
        /// Nullable, as no record may be selected.
        /// </summary>
        [ObservableProperty] private SamsungFoodInfoModel? selectedData;
        ...
        /// </remarks>
        public DBEntryFoodInfoViewModel(DatabaseService db)
        {
            databaseService = db;
        ...
        private async Task ReloadAsync()
        {
            ...
            await GetCurrentFoodInfos(pid);
        }

        /// <summary>
        /// Asynchronously retrieves the current food info records for the specified person identifier from the database and updates the observable collection.
        /// </summary>
        /// <param name="pid">The unique person identifier used to query current food info entries.</param>
        ...
        /// </remarks>
        partial void OnSelectedDataChanged(SamsungFoodInfoModel? value)
        {
        ...
        private async Task DeleteSelectedAsync()
        {
            try
            {
                ...
                if (SelectedData.FoodInfoID.HasValue) await databaseService.GetFoodInfoDeleteSqlAsync(SelectedData.FoodInfoID.Value);
                await ReloadAsync();
            }
            catch (Exception ex)
            {
