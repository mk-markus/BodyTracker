...
{
    public partial class WorkoutImportViewModel : ObservableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkoutImportViewModel"/> class, 
        ...
        private async Task OpenAsync()
        {
            ...
            try
            {
                ...
                var list = await HeavyAppCSVExtractor.ExtractAsync(filePath,
                    progress,
