...
{
    public partial class StepTrendImportViewModel : ObservableObject
    {
        /// <summary>
        ...
        /// </summary>
        [ObservableProperty] private ObservableCollection<SamsungStepTrendModel> stepTrendDatas;
        ...
        /// </summary>
        private string searchTerm = "step_daily_trend";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StepTrendImportViewModel"/> class, 
        ...
        public StepTrendImportViewModel(DatabaseService db, string path)
        {
            databaseService = db;
            searchPath = path;
        ...
        private async Task OpenAsync()
        {
            ...
            try
            {
                ...
                var list = await SamsungDataCsvExtractor.ParseStepTrendAsync(
                    filePath,
                    progress,
                    new Progress<string>(text => ProgressText = text));

                StepTrendDatas = new ObservableCollection<SamsungStepTrendModel>(list);
        ...
        /// <summary>
        /// Asynchronously uploads the loaded <see cref="StepTrendDatas"/> entries 
