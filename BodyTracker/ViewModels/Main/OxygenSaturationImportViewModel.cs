...
{
    public partial class OxygenSaturationImportViewModel : ObservableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the collection of <see cref="SamsungOxygenSaturationModel"/> objects currently loaded in the view.
        /// </summary>
        [ObservableProperty] private ObservableCollection<SamsungOxygenSaturationModel> oxygenSaturationDatas;
        ...
        /// </summary>
        private string searchTerm = "tracker.oxygen_saturation";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OxygenSaturationImportViewModel"/> class, 
        ...
        public OxygenSaturationImportViewModel(DatabaseService db, string path)
        {
            databaseService = db;
            searchPath = path;
        ...
        /// <summary>
        /// Asynchronously uploads the loaded <see cref="OxygenSaturationDatas"/> entries 
        /// to the database for the currently selected person, reporting progress along the way.
        /// </summary>
        /// <returns>A task representing the asynchronous operation.</returns>
        private async Task InsertAsync()
        {
            if (OxygenSaturationDatas == null || OxygenSaturationDatas.Count == 0)
            {
        ...
        private async Task OpenAsync()
        {
            ...
            try
            {
                ...
                var list = await SamsungDataCsvExtractor.ParseOxygenSaturationAsync(
                    filePath,
                    progress,
                    new Progress<string>(text => ProgressText = text));

                OxygenSaturationDatas = new ObservableCollection<SamsungOxygenSaturationModel>(list);
