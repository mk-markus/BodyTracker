...
namespace BodyTracker.ViewModels
{
    ...
    public partial class StartPageViewModel : ObservableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartPageViewModel"/> class with the specified main window shell and database service.
        /// </summary>
        ...
        public StartPageViewModel(MainWindow shell, DatabaseService db)
        {
            ...
            ActualUser = databaseService.actualDatabaseUser + " / " + AppState.SelectedPersonName;
        ...
        private async Task HandleDatabaseErrorMessageWithConnectionCheckAsync(string message, long targetVersion, TimeSpan delay)
        {
            ...
            while (!databaseService.ServerConnectionOK)
            {
