...
{
    public partial class HeartRateImportViewModel : ObservableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the collection of <see cref="SamsungHeartRateModel"/> objects currently loaded in the view.
        /// </summary>
        [ObservableProperty] private ObservableCollection<SamsungHeartRateModel> heartRateDatas;
        ...
        /// </summary>
        private string searchTerm = ".shealth.tracker.heart_rate.??????????????";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HeartRateImportViewModel"/> class, 
        ...
        public HeartRateImportViewModel(DatabaseService db)
        {
            databaseService = db;
        ...
        /// <summary>
        /// Asynchronously uploads the loaded <see cref="HeartRateDatas"/> entries 
        /// to the database for the currently selected person, reporting progress along the way.
        /// </summary>
        /// <returns>A task representing the asynchronous operation.</returns>
        private async Task InsertAsync()
        {
            if (HeartRateDatas == null || HeartRateDatas.Count == 0)
            {
        ...
        private async Task OpenAsync()
        {
            ...
            try
            {
                ...
                var list = await SamsungDataCsvExtractor.ParseHeartRateAsync(
                    filePath,
                    progress,
                    new Progress<string>(text => ProgressText = text));

                HeartRateDatas = new ObservableCollection<SamsungHeartRateModel>(list);
