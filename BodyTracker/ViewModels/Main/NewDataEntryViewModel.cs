...
{
    /// <summary>
    /// Represents the view model for entering and managing body bodyMeasurement data, including physiological metrics and
    ...
    public partial class NewDataEntryPageViewModel : ObservableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the date of the bodyMeasurement. Defaults to the current system date.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the breast skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Gets or sets the armpit skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Gets or sets the abdominal skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Gets or sets the hip skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Gets or sets the thigh skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Gets or sets the back skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// <summary>
        /// Gets or sets the triceps skinfold bodyMeasurement value.
        /// </summary>
        [ObservableProperty]
        ...
        /// </summary>
        /// <param name="value">The new string representation of the fat tongs bodyMeasurement.</param>
        ...
        /// <summary>
        /// Handles the validation logic when the armpit skinfold bodyMeasurement changes.
        /// </summary>
        ...
        /// <summary>
        /// Handles the validation logic when the abdominal skinfold bodyMeasurement changes.
        /// </summary>
        /// <param name="value">The new input value as a string.</param>
        ...
        /// <summary>
        /// Handles the validation logic when the hip skinfold bodyMeasurement changes.
        /// </summary>
        /// <param name="value">The new input value as a string.</param>
        ...
        /// <summary>
        /// Handles the validation logic when the thigh skinfold bodyMeasurement changes.
        /// </summary>
        /// <param name="value">The new input value as a string.</param>
        ...
        /// <summary>
        /// Handles the validation logic when the back skinfold bodyMeasurement changes.
        /// </summary>
        /// <param name="value">The new input value as a string.</param>
        ...
        /// <summary>
        /// Handles the validation logic when the triceps skinfold bodyMeasurement changes.
        /// </summary>
        /// <param name="value">The new input value as a string.</param>
        ...
        /// <summary>
        /// Gets a value indicating whether the breast skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        bool IsFatTongBreastCreaseValid => TryParseFloat(FatTongBreastCrease, out var v) && IsNumberValid(v);

        /// <summary>
        /// Gets a value indicating whether the armpit skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        bool IsFatTongArmpitCreaseValid => TryParseFloat(FatTongArmpitCrease, out var v) && IsNumberValid(v);

        /// <summary>
        /// Gets a value indicating whether the abdominal skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        bool IsFatTongAbdominalCreaseValid => TryParseFloat(FatTongAbdominalCrease, out var v) && IsNumberValid(v);

        /// <summary>
        /// Gets a value indicating whether the hip skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        bool IsFatTongHipCreaseValid => TryParseFloat(FatTongHipCrease, out var v) && IsNumberValid(v);

        /// <summary>
        /// Gets a value indicating whether the thigh skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        bool IsFatTongThighCreaseValid => TryParseFloat(FatTongThighCrease, out var v) && IsNumberValid(v);

        /// <summary>
        /// Gets a value indicating whether the back skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        bool IsFatTongBackCreaseValid => TryParseFloat(FatTongBackCrease, out var v) && IsNumberValid(v);

        /// <summary>
        /// Gets a value indicating whether the triceps skinfold bodyMeasurement is valid and can be parsed as a float.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewDataEntryPageViewModel"/> class.
        /// </summary>
        /// <param name="db">
        ...
        /// </remarks>
        public NewDataEntryPageViewModel(DatabaseService db) 
        { 
            databaseService = db;
        ...
        /// <summary>
        /// Asynchronously persists the current bodyMeasurement data to the database.
