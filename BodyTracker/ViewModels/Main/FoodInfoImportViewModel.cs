...
{
    public partial class FoodInfoImportViewModel : ObservableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Asynchronously uploads the loaded <see cref="FoodInfoDatas"/> entries 
        /// to the database for the currently selected person, reporting progress along the way.
        /// </summary>
        /// <returns>A task representing the asynchronous operation.</returns>
        private async Task InsertAsync()
        {
            if (FoodInfoDatas == null || FoodInfoDatas.Count == 0)
            {
