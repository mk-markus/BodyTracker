...
namespace BodyTracker.ViewModels
{
    ...
    /// </summary>
    partial class LauncherNewDatabasePersonPageViewModel : ObservableObject, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public LauncherNewDatabasePersonPageViewModel()
        {
        ...
        private async Task CreatePersonAsync()
        {
            ...
            WeakReferenceMessenger.Default.Send(new NavigationMessage(NavigationMessage.ShowLaunscherHomepage));
        }
        ...
        /// <summary>
        /// Releases all resources used by the <see cref="LauncherNewDatabasePersonPageViewModel"/> class, suppressing finalization.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
