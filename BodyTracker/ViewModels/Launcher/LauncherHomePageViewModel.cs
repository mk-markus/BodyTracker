...
namespace BodyTracker.ViewModels
{
    ...
    /// </summary>
    public partial class LauncherHomePageViewModel : ObservableObject, IDisposable
    {
        /// <summary>
        ...
        public string ActualUser
        {
            ...
            set
            {
                ...
                {
                    WeakReferenceMessenger.Default.Send(new LoggedInDatabaseUserMessage(actualUser));
                }
            }
        }
        ...
        public string ActualDatabase
        {
            ...
            set
            {
                ...
                {
                    WeakReferenceMessenger.Default.Send(new UsedAcutalDatabaseNameMessage(acutalDatabase));
                }
            }
        }
        ...
        public string DatabaseAdditonalConncetionStateInfo
        {
            ...
            set
            {
                ...
                {
                    WeakReferenceMessenger.Default.Send(new DatabaseAdditionalConnectionStateMessage(databaseAdditonalConncetionStateInfo));
                }
            }
        }
        ...
        public LauncherHomePageViewModel(LauncherWindow shell)
        {
        ...
        public async Task<bool> InitializeAsync()
        {
            try
            {
                ...
                try
                {
                    ...
                    ActualUser = databaseService.actualDatabaseUser;
                    ActualDatabase = databaseService.acutalDatabaseName;

                    databaseAdditonalConncetionStateInfo = databaseService.ServerConnectionOK ? "Connected" : "Not Connected";
