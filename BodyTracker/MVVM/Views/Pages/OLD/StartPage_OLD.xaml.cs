...
namespace BodyTracker.MVVM.Views
{
    ...
    public partial class StartPage : Page
    {
        ...
        private FoodIntakeImportPage newFoodIntakePage;
        ...
        public StartPage(MainWindow shell, DatabaseService databaseService)
        {
            ...
            newFoodIntakePage = new FoodIntakeImportPage(mainWindow, this.databaseService);

            newStepDailyTrendPage = new StepDailyTrendImportPage(mainWindow, this.databaseService);
