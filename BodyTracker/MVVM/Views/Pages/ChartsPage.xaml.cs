...
namespace BodyTracker.MVVM.Views
{
    ...
    public partial class ChartsPage : Page
    {
        ...
        private void GetAllMeasurementsClick(object sender, RoutedEventArgs e)
        {
            chartsPageViewModel.StartDate = chartsPageViewModel.minMeasurementsDate;
                chartsPageViewModel.EndDate = chartsPageViewModel.maxMeasurementsDate;
