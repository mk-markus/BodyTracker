...
namespace BodyTracker.MVVM.ViewModels
{
    ...
    {
        /// <summary>
        /// A private, read-only reference to the <see cref="DatabaseService"/> for retrieving measurement data.
        /// </summary>
        ...
        /// <summary>
        /// Command to set the chart date range to include all historical measurement data.
        /// </summary>
        public IRelayCommand ShowAllDataCommand { get; }

        /// <summary>
        /// The earliest date found in the available measurement dataset.
        /// </summary>
        private DateTime minMeasurementsDate;

        /// <summary>
        /// The latest date found in the available measurement dataset.
        /// </summary>
        ...
        public async Task RefreshChartAsync()
        {
            ...
            try
            {
                var data = await _db.GetStepDailyTrendAsync(
                    AppState.SelectedPersonId);
